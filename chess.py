...
class BaseBoard:
    ...
    def _reset_board(self) -> None:
        ...
        self.occupied_co[RED] = between(50,60) | BB_B2 | BB_H2 | BB_RED_PAWNS
        self.occupied_co[BLACK] = between(194,204) | BB_B7 | BB_H7 | BB_BLACK_PAWNS
